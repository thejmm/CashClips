...
import { DataTableFacetedFilter } from "../ui/faceted-filter";
...
const CreatedPage: React.FC = () => {
  ...
  const handleDownload = async (url: string) => {
    try {
      ...
      const response = await fetch(url, {
        mode: "cors", // Ensure CORS is allowed for cross-origin requests
      });
  ...
  return (
    <div className="w-full max-w-[23rem] md:max-w-7xl mx-auto space-y-8 p-4">
      <h1 className="text-2xl font-bold mb-6">Your Created Clips</h1>
